      ...
      *-------------                                                    00090000
       ...
       01  REPREC.                                                      00141000
           ...
           05  ACCT-TRAIL-O   PIC X(62).                                00141701
       FD      CARDIN                                                   00142000
      ...
      *****************************************************             00310000
                EXEC SQL DECLARE Z45864T TABLE                          00320000
      ...
      *****************************************************             00460000
                EXEC SQL DECLARE CUR1  CURSOR FOR                       00470000
                         SELECT * FROM Z45864T                          00480000
                     END-EXEC.                                          00490000
                EXEC SQL DECLARE CUR2  CURSOR FOR                       00491000
                         SELECT *                                       00492000
                         FROM   Z45864T                                 00493000
                         WHERE  ADDRESS3 = :STATE                       00494002
                      END-EXEC.                                         00495000
      *****************************************************             00500000
      ...
      *------------------                                               00660000
       ...
       PRINT-A-LINE.                                                    00890000
                ...
                MOVE  SPACES       TO  ACCT-TRAIL-O.                    00942001
