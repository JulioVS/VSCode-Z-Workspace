//ETEMPLJ     JOB FB3,,REGION=0M,NOTIFY=&SYSUID
//*
//* COBOL CICS COMPILE JOB (EMPLOYEE APP TEMPLATE PROGRAM)
//*
//CICSPROG   EXEC DFHZITCL                       IBM CICS COMPILE PROC
//COBOL.SYSIN  DD DISP=SHR,DSN=&SYSUID..CBL(ETEMPL)   MY COBOL PROGRAM
