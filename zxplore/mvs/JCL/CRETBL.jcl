//CREATE1   JOB 1,NOTIFY=&SYSUID                                        00000102
//SQLEXEC   EXEC DB2JCL                                                 00000202
//SYSIN    DD *,SYMBOLS=CNVTSYS                                         00000302
--** SQL FOLLOWS ****************************************               00000402
--DROP TABLESPACE &SYSUID..&SYSUID.S;
--COMMIT;                                                               00050000
  SET CURRENT SCHEMA &SYSUID.;
  CREATE TABLESPACE &SYSUID.S  IN &SYSUID.
    USING STOGROUP ZXPUSER PRIQTY 20 SECQTY 20 ERASE NO                 00000600
...
--*******************************************************               00060000
  CREATE UNIQUE INDEX &SYSUID.I                                         00070000
                   ...
                   USING STOGROUP ZXPUSER  PRIQTY 12 ERASE NO           00080100
