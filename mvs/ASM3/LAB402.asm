...
*        making any changes.
*
*  --->  In this lab, we use the PUT macro to write, instead of
*        calling PUT1.
*
*---------------------------------------------------------------------*
LAB402   CSECT
...
DOB_DD   DS    CL2                 Day
*---------------------------------------------------------------------*
LAB402   CSECT                    Back to our CSECT
*
         STM   R14,R12,12(R13)    Save caller's registers
         LARL  R12,LAB402         Load the address of LAB402 into R12
         USING LAB402,R12         Use R12 as base register
*
...
*
         DROP  R5
*---------------------------------------------------------------------*
         PUT   EMP_OUT,Output     Print output record
*---------------------------------------------------------------------*
         B     Read               Loop until no more records
*---------------------------------------------------------------------*
Return   CLOSE (EMP_OUT)          Close output data set
...
SAVEAREA DS    18F
*---------------------------------------------------------------------*
EMP_OUT  DCB   DSORG=PS,MACRF=PM,DDNAME=SYSPRINT,LRECL=121,RECFM=FBA
*---------------------------------------------------------------------*
