...
*        making any changes.
*
*  --->  In this lab, we will examine the code in GET1 and PUT1.
*
*---------------------------------------------------------------------*
LAB401   CSECT
*
...
DOB_DD   DS    CL2                 Day
*---------------------------------------------------------------------*
LAB401   CSECT                    Back to our CSECT
*
         STM   R14,R12,12(R13)    Save caller's registers
         LARL  R12,LAB401         Load the address of LAB401 into R12
         USING LAB401,R12         Use R12 as base register
*
