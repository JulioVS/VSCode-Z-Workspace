...
*        that copies 8000 bytes from SRC to TGT.
*
...
LAB501   CSECT
*
R0       EQU   0                  MVCL source address
R1       EQU   1                  MVCL source length
...
*---------------------------------------------------------------------*
         ...
         LARL  R12,LAB501         Load the address of LAB501 into R12
         USING LAB501,R12         Use R12 as base register
*
...
*---------------------------------------------------------------------*
*
*  --->  Code the instruction to load the addess of SRC in R0.
*
         LA    R0,SRC
*
*  --->  Code the instruction to load the length of SRC in R1.
*
         LHI   R1,8000
*
*  --->  Code the instruction to load the addess of TGT in R8.
*
         LAY   R8,TGT
*
*  --->  Code the instruction to load the length of TGT in R9.
*
         LHI   R9,8000
*
...
SAVEAREA DC    18F'0'    Area for callee to save and restore my regs
         DC    X'33333333'        Dump eyecatcher
SRC      DC    8000C'*'           Source string (8.000 asterisks)
         DC    X'44444444'        Dump eyecatcher
TGT      DC    8000C'-'           Target string (8.000 dashes)
