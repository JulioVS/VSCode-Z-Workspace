//MYPLIRUN  JOB FB3,,REGION=0M,NOTIFY=&SYSUID
//*
//*   MY IMS PL/I DL/I RUN JOB
//*
//SETLIB   JCLLIB ORDER=DFSF10.PROCLIB
//*
//IMSPLI   EXEC DLIBATCH,
//             MBR='PLIDBLAB',                   IMS DB LABS PROGRAM
//             PSB='PSB1PLI',                             MY OWN PSB
//             DBRC='N',                                   NO RECON!
//             IRLM='N'                                    NO LOCKS!
//*
...
*---------------------------------------------------------------
5
OBU115   AKERSON, LAWRENCE R.                      1000
OKB750   FREIDMAN, JACK A.                         1000
OEK999   LINDHOLM, THOMAS C.                       2000
OED003   FERRIS, MONA J.                           1000
*---------------------------------------------------------------
* LAST INPUT
*---------------------------------------------------------------
E
